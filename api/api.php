...
// uncomment the lines below for token+session based authentication (see "login_token.php" + "login_token.php"):
...
// uncomment the lines below for form+session based authentication (see "login.php"):
...
$key1 = 'WNetcNnHuxs2VjwtjfBA78m3whhMZV5dXddKXQrTkMLVvq75HpESRLf9GawVpef4';
$key2 = '5f3Sn4Lvp2jz4ysrFCMMxAD5k5kqsuULvMBfwa6zyaxkbb86TTZEREWhd2V58aH4';
$key3 = 'kY2WC6nSeGRgmVRGdfBKDVKrVdAt9wKCH6P9NsYdN4MVsgbvmgJjRK29phfEWHqy';

if($_GET['key'] === $key1 || $_GET['key'] === $key2 || $_GET['key'] === $key3)
